...
type
  TPlugInEvent = procedure(Sender: TObject) of object;
  TPlugOutEvent = procedure(Sender: TObject) of object;

  TUSBSerialPortMonitor = class(TThread)
  private
    FMonitorHandle: THandle;
    FComPort: string;
    FOnPlugIn: TPlugInEvent;
    FOnPlugOut: TPlugOutEvent;
    procedure DoPlugIn;
    procedure DoPlugOut;
  protected
  ...
  public
    ...
    property OnPlugIn: TPlugInEvent read FOnPlugIn write FOnPlugIn;
    property OnPlugOut: TPlugOutEvent read FOnPlugOut write FOnPlugOut;
    const
