...
type
  TUMainModule = class(TDataModule)
    ...
    tblSearchMemberConsumerDateRegistered: TDateTimeField;
    FDQuery4: TFDQuery;
    FDQuery4id: TFDAutoIncField;
    FDQuery4AccountNumber: TStringField;
    FDQuery4Name: TStringField;
    FDQuery4Area: TStringField;
    FDQuery4Address: TStringField;
    FDQuery4Status: TIntegerField;
    FDQuery4ShuffleOrder: TIntegerField;
    FDQuery4ConnectionStatus: TLongWordField;
    FDQuery4EntryMode: TStringField;
    FDQuery4Year: TLongWordField;
    FDQuery4Gender: TStringField;
    FDQuery4isPosted: TLongWordField;
    FDQuery4RateCode: TStringField;
    FDQuery4IsQualifiedForRaffle: TShortintField;
    FDQuery4IsSignatureAvailable: TShortintField;
    FDQuery4DateRegistered: TDateTimeField;
    qryAllAttendie: TFDQuery;
