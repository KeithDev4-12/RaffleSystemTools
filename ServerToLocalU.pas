...
begin
  with UMainModule do begin
    ...
    while Not qryMaster.EOF do begin
      ...
      qryUnPaidBills.ParamByName('ACode').AsString := qryMasterCode.AsString;;
      qryUnPaidBills.Open;
      qryUnPaidBills.First;

      VTMemberConsumer.Append;
      VTMemberConsumerAccountNumber.AsString := qryMasterAccountNumber.AsString;
      VTMemberConsumerName.AsString := qryMasterName.AsString;
      VTMemberConsumerArea.AsString := qryMasterArea.AsString;
      VTMemberConsumerAddress.AsString := qryMasterAddress.AsString;
