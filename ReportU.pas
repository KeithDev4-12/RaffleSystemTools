...
type
  TUReport = class(TForm)
    ...
    qryAGMAAttendanceid: TFDAutoIncField;
    qryAGMAAttendanceAccountNumber: TStringField;
    qryAGMAAttendanceName: TStringField;
    qryAGMAAttendanceArea: TStringField;
    qryAGMAAttendanceAddress: TStringField;
    qryAGMAAttendanceShuffleOrder: TIntegerField;
    qryAGMAAttendanceEntryMode: TStringField;
    qryAGMAAttendanceYear: TLongWordField;
    qryAGMAAttendanceNotes: TStringField;
    ...
    qryAGMAAttendanceMagic: TFDQuery;
